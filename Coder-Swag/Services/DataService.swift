...
class DataService{
    ...
    private let shirts = [
       ...
       Product(title: "Devslopes Badge Shirt Light Grey", price: "$32", imageName: "hoodie02.png"),
       Product(title: "Devslopes Logo Shirt Red", price: "$19", imageName: "hoodie03.png"),
       Product(title: "Devslopes Logo Shirt Black", price: "$32", imageName: "hoodie04.png"),
        Product(title: "Kickflip Studio Black", price: "$20", imageName: "hoodie05.png")
       ]
